...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    JALogI(@"Application starting on: %@ v%@", [[UIDevice currentDevice] systemName], [[UIDevice currentDevice] systemVersion]);
	JALogI(@"Application Documents path: %@", [JAUtils applicationDocumentsPath]);
